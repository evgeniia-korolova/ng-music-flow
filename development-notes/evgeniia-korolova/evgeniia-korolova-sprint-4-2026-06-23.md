...
- history - переписала в соответствии с dto back 😶‍🌫️, переключила на сигнальный стор, синтаксис 🥶, но удобно для дебага, плюс не нужно писать фолбеки для объектов как в случае с rxResourse, от промисов избавилась, будет еще один пример data-management, перенесла загрузку истории из стора withHooks в компонент при условии успешно зарегистрированного пользователя (мешать один стор с другим посчитала плохой практикой)
- сорри, что не на английском, сегодня голова уже не варит, а завтра увлекусь и забуду, чем занималась сегодня. И вообще - самое сложное в проекте - это интерфейсы и дизайн
...
2. Diving Into the Backend (The Root Causes) - Gemini greatly helped to untide this knot
   ...
   Устала как собака, вроде состыковали фронт с беком, осталось только понять ка исправить волну. Nest.js сам по себе понятен, сложнее понять техническую часть - сопряжение БД, бек, фронт
